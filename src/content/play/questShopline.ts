...
const beats: Record<string, QuestBeat> = {
  ...
  q4: {
    ...
    slots: [
      { id: "code", label: "HTTP код повтора", accept: ["409"], hint: "Не 200." },
      { id: "id", label: "Поле существующего заказа", accept: ["order_id", "orderid", "existing_id", "existingid", "id заказа"], hint: "Как клиент найдёт первый." },
      { id: "reason", label: "Поле причины", accept: ["reason", "причин", "duplicate", "дубл"], hint: "Почему не создали второй." },
    ],
    passNeed: 2,
